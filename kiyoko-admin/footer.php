...
<div class="mt-auto p-6 pt-0 text-center dark:text-white-dark ltr:sm:text-left rtl:sm:text-right">
                    © <span id="footer-year">2022</span>. Kiyoko Admin All rights reserved.
                </div>
                <!-- end footer section -->
            </div>
        </div>
                    ...
                    messages: [
                        {
                            ...
                            message: 'Kiyoko has been completed!!',
                            time: '1m ago',
                        },
                        {
                            id: 2,
                            ...
                            message: 'Contact me ducvan05102002@gmail.com',
                            time: 'now',
                        },
                    ],
...
<script>
    function showComingSoon() {
        Swal.fire({
            ...
            text: 'We will release this feature soon.',
            icon: 'info',
